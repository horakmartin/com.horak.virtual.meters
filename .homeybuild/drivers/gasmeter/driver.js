...
class GasMeterDriver extends Homey.Driver {
  async onInit() {
    this.homey.app.log('GasMeterDriver ready');
  }

  async onPair(session) {
    session.setHandler('list_devices', async () => [{ name: 'Virtual Gas Meter', data: { id: String(Date.now()) } }]);
